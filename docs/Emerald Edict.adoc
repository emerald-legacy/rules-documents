...
== Rally Keyword
A maximum of five copies of cards with the Rally keyword can be included in your deck.
These count towards maximum, but not minimum deck size.


== Banned Cards
// One cell per clan: Prawn keeps a table cell whole, so a clan never
// splits across a column break. Nothing here is balanced by hand.
[.clan-block]
...
* https://www.emeralddb.org/card/doji-diplomat[Dōji Diplomat]
...
* https://www.emeralddb.org/card/hayaken-no-shiro[Hayaken no Shiro]
...
|
=== image:mons/phoenix.svg[width=20] [.phoenix]#Phoenix#
* https://www.emeralddb.org/card/asako-kousuke[Asako Kousuke]
...
* https://www.emeralddb.org/card/sinister-peacekeeper[Sinister Peacekeeper]
|===
...
Rotated are all cards of the https://www.emeralddb.org/cards?cycle=core[original FFG Core Set] as well as the https://www.emeralddb.org/cards?cycle=imperial[complete Imperial Cycle], the https://www.emeralddb.org/cards?cycle=elemental[complete Elemental Cycle],
and the https://www.emeralddb.org/cards?cycle=inheritance[complete Inheritance Cycle].
