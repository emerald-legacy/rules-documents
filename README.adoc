...
- `rake copy_theme` - Copy the HTML theme to the build directory
- `rake clean` - Remove generated HTML and PDF files
- `rake clobber` - Remove the entire build directory

The PDF styling lives in `pdf-theme/`, the HTML styling in `html-theme/`
(`el.css` plus the webfonts and border tiles it references). Both documents
